...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/dashboard-dark.svg?v=f4fa4fcac052">
  <source media="(prefers-color-scheme: light)" srcset="assets/dashboard-light.svg?v=f4fa4fcac052">
  <img alt="Live source repository signals" src="assets/dashboard-light.svg?v=f4fa4fcac052" width="100%">
</picture>
