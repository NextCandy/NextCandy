...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/dashboard-dark.svg?v=bbcdb56f76ef">
  <source media="(prefers-color-scheme: light)" srcset="assets/dashboard-light.svg?v=bbcdb56f76ef">
  <img alt="Live source repository signals" src="assets/dashboard-light.svg?v=bbcdb56f76ef" width="100%">
</picture>
