...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/dashboard-dark.svg?v=8977411ca1fc">
  <source media="(prefers-color-scheme: light)" srcset="assets/dashboard-light.svg?v=8977411ca1fc">
  <img alt="Live source repository signals" src="assets/dashboard-light.svg?v=8977411ca1fc" width="100%">
</picture>
...
<!-- Live dashboard data is generated by scripts/update_dashboard.py on a 15-minute schedule (GitHub may delay scheduled runs). Times are latest source-commit times in Beijing time (Asia/Shanghai, UTC+8). -->
