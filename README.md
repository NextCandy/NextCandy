...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/dashboard-dark.svg?v=2b383648ba89">
  <source media="(prefers-color-scheme: light)" srcset="assets/dashboard-light.svg?v=2b383648ba89">
  <img alt="Live source repository signals" src="assets/dashboard-light.svg?v=2b383648ba89" width="100%">
</picture>
